...
seeded_projects = [
  ...
  Project(name='Web Updates', description='A place for the web team to coordinate any updates.', creator_id=11),
  Project(name='Photography Assignments', description='Organizing photography assignments.', creator_id=11),
  Project(name='Graphic Design Needs', description='Planning any work the graphic design team will need to attend to.', creator_id=11),
